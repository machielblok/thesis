...
\begin{figure*}[h]
	\centering
	\includegraphics[width=12cm]{figures/fig_S1}
...
\begin{figure*}[h]
	\centering
	\includegraphics[width=6cm]{figures/fig_S2}
...
Comparison between protocols is easier when plotting only the minimum sensitivity vs $F$. This is shown in \ref{fig:ammS2} for perfect readout fidelity $F_0=1$. We find that for $F<2$, the limited-adaptive protocol outperforms the non-adaptive protocol. This is expected since in this region only the limited-adaptive protocol exhibits Heisenberg-like scaling. However, once the non-adaptive protocol achieves Heisenberg-like scaling ($F\geq2$) it reaches a lower sensitivity.

On the scale at the top of \ref{fig:ammS2}, the number of Ramsey runs corresponding to an estimation sequence with $N = 10$ different sensing times is reported. By increasing $F$, the number of Ramsey experiments increases as:
...
\begin{figure*}[h]
	\centering
	\includegraphics[width=12cm]{figures/fig_S4_new}
...
\begin{figure*}[h]
	\centering
	\includegraphics[width=6cm]{figures/fig_S5}
...
\begin{figure*}[h]
	\centering
	\includegraphics{figures/Failed_CR_checks}
