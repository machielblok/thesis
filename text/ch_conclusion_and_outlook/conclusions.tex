...
general \cite{Taylor_NatPhys_2008,Schirhagl__2014}
such as temperature\cite{Acosta_Phys.Rev.Lett._2010,Toyli_PNAS_2013}, strain\cite{Ovartchaiyapong_NatCommun_2014} and electric and magnetic fields\cite{Taylor_NatPhys_2008,Dolde_NatPhys_2011}
scanning probe \cite{Balasubramanian_Nature_2008,Maletinsky_NatNano_2012,Rondin__2012,Pelliccione_Phys.Rev.Applied_2014,Haberle_NatNano_2015}
solid state sensing with bulk (surface) diamonds: probing johnson noise\cite{Kolkowitz_Science_2015} spin waves\cite{vanderSar_NatCommun_2015}
living cell bulk \cite{LeSage_Nature_2013}) nanocrystals \cite{Kucsko_Nature_2013}
